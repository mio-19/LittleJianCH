...
object ToStringRecCatcherState {
  def empty: ToStringRecCatcherState = ToStringRecCatcherState(new ToStringRecCatcherCounter, scala.collection.immutable.HashSet.empty, new scala.collection.mutable.HashMap())
}
