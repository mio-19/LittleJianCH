...
sealed trait LList[T] derives Unify, Inspect, DeepWalk
...
case class LEmpty[T]() extends LList[T] derives Unify, Inspect, DeepWalk {
  override def toString: String = "LList()"
}

case class LCons[T](head: VarOr[T], tail: VarOr[LList[T]]) extends LList[T] derives Unify, Inspect, DeepWalk {
