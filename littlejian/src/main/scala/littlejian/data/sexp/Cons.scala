...
implicit val U$SExp: Unifier[SExp] = U$Union(U$Pair(U$Fix(U$SExp), U$Fix(U$SExp)), U$Unit, U$String)

implicit val I$SExp: Inspector[SExp] = I$Union(I$Pair(I$Fix(I$SExp), I$Fix(I$SExp)), I$Unit, I$String)
